...
def readFileContents(filepath, filename):
    ...
    sql = "INSERT INTO patient_chart_notes (recordID, fileMatchID, fk_patientID, mrn, notes) VALUES (%s, %s, %s, %s, %s);"
    sqlutils.execMysqlQuery(sql, (recordID, fileMatchID, patientID, mrn, contents))
